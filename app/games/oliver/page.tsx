  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-8">
        <p className="font-pixel text-xs text-christmas-green mb-2">OLIVER</p>
        <h1 className="font-pixel text-xl text-foreground mb-4">CODE QUEST</h1>
        <p className="text-gray-600 max-w-md mx-auto">
          Solve bite-sized JavaScript puzzles to level up your coding skills.
          Choose your difficulty and start coding.
        </p>
      </div>
